...
REVIEW_SYSTEM = (
    ...
    "paper's own result, or a table-header/label mistaken for a value. Kill "
    "DIFFERENCES POSING AS VALUES: a quantity quoted as a drop, reduction, "
    "increase, or change ('results in a 0.6 W/mK drop of kappa') is a DELTA, "
    "not a value of the mapped quantity; mapping it onto an absolute-value "
    "node would corrupt the record. Kill "
    "DESCRIPTIVE SPECTRAL MARKERS: a frequency or energy quoted as a band "
    "edge, threshold, or crossover in running prose ('modes below 4 THz', "
    "'the crossover near 8 THz', 'up to 500 cm-1') is narrative structure, "
    "not a reported result; a genuine measured or computed peak/mode value "
    "(a Raman shift, an IR peak, a table entry) stays. Only confirm a claim "
    "you cannot refute.\n\n"
