...
% FC order=3 branch (sub-row, abstract only — its representations slot beneath FC2)
...
\begin{scope}[shift={(0, -10.0)}, font=\scriptsize]
  ...
  \node[anchor=west] at (lK.east) {\,kaldo representation};

  \node[phono, minimum width=1.6cm, minimum height=0.5cm, text width=, inner sep=2pt] (lP) at (15.0,0) {};
  \node[anchor=west] at (lP.east) {\,phonopy / phono3py representation};
  ...
  \draw[matarr]  (10.6, -0.7) -- ++(1.2, 0); \node[anchor=west] at (11.9, -0.7) {\,representation link};
\end{scope}
