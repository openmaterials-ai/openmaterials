...
55 quantities and 53 operators is content-addressed in the log-first store
...
\begin{itemize}[leftmargin=2em, itemsep=0.2em]
  ...
  \item \textbf{Further domains through the same gates}: the deferred
        ...
        first post-genesis Pattern C producer.
\end{itemize}
...
\texttt{950910596b2ce9c9169a9a396a05e12539ef9d99094111506ad6f8ec6b19685c}
(2026-07-08, 109 records), nine change records past the frozen genesis hash
\texttt{e6e8044e92039696417b53b220b0f3f10559a286b0eaabbe7ea4167ff510f6cd}
...
\begin{itemize}[leftmargin=2em, itemsep=0.25em]
  \item \textbf{Structure.} 55 nodes (52 observable and hidden quantities plus 3
        promoted parameters), 139 rendered links, 53 deduplicated operators. The
  ...
  \item \textbf{Dimensional gate.} Of the 53 edges, 21 are ok, 2 are
