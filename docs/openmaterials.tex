...
103 quantities and 102 operators is content-addressed in the log-first store
(Part~\ref{part:kernel}), grown past its frozen genesis version through the
contribution gates, and the whole is held together by a suite of 1407
passing tests.
...
The map is a curated reference graph. Today it holds 103 nodes (100 observable
and hidden quantities plus 3 promoted parameters) and 253 edges. Nodes are
...
Today's map is one hundred seventeen change records past v1, its frozen genesis version:
...
\texttt{275d97d38696e29671046eab8db702e80cb42c5879ad189fb18e4f9ce26540d9}
(2026-07-12, 217 records), one hundred seventeen change records past the frozen genesis hash
\texttt{e6e8044e92039696417b53b220b0f3f10559a286b0eaabbe7ea4167ff510f6cd}
(2026-07-07, the untouched 100-record prefix). The live numbers:

\begin{itemize}[leftmargin=2em, itemsep=0.25em]
  \item \textbf{Structure.} 103 nodes (100 observable and hidden quantities plus 3
        promoted parameters), 253 rendered links, 102 deduplicated operators,
  ...
  \item \textbf{Tests.} The suite is 1407 passing.
\end{itemize}
