...
100 quantities and 96 operators is content-addressed in the log-first store
...
The map is a curated reference graph. Today it holds 100 nodes (97 observable
and hidden quantities plus 3 promoted parameters) and 247 edges. Nodes are
...
Today's map is one hundred eleven change records past v1, its frozen genesis version:
97 typed quantities plus 3 promoted
...
\begin{itemize}[leftmargin=2em, itemsep=0.25em]
  ...
  \item \textbf{Tests.} The suite is 1372 passing.
\end{itemize}
