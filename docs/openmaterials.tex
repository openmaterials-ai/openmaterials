...
107 quantities and 109 operators is content-addressed in the log-first store
...
The map is a curated reference graph. Today it holds 107 nodes (104 observable
and hidden quantities plus 3 promoted parameters) and 259 edges. Nodes are
...
\begin{itemize}[leftmargin=2em, itemsep=0.25em]
  \item \textbf{Structure.} 107 nodes (104 observable and hidden quantities plus 3
        promoted parameters), 259 rendered links, 105 deduplicated operators,
