...
104 quantities and 103 operators is content-addressed in the log-first store
...
The map is a curated reference graph. Today it holds 104 nodes (101 observable
...
Today's map is one hundred nineteen change records past v1, its frozen genesis version:
...
\texttt{a4a60afe3fe692e67f1044cb6899c0a67550942092b192b9d9df4d455c0c6bcb}
(2026-07-12, 219 records), one hundred nineteen change records past the frozen genesis hash
\texttt{e6e8044e92039696417b53b220b0f3f10559a286b0eaabbe7ea4167ff510f6cd}
(2026-07-07, the untouched 100-record prefix). The live numbers:

\begin{itemize}[leftmargin=2em, itemsep=0.25em]
  \item \textbf{Structure.} 104 nodes (101 observable and hidden quantities plus 3
        promoted parameters), 255 rendered links, 103 deduplicated operators,
  ...
  \item \textbf{Tests.} The suite is 1408 passing.
\end{itemize}
