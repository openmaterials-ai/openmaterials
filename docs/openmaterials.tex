...
\begin{itemize}[leftmargin=2em]
  \item \textbf{Verification.} Project the operator layer into Lean (via PhysLean or alongside
        ...
        The first tier of this is built (2026-07-12): \texttt{omai.physlean\_export} generates
        ...
        omitted honestly, since PhysLean's \texttt{Dimension} has no base for them. So the
        dimensional layer type-checks in a proof assistant today; the approximation-error
