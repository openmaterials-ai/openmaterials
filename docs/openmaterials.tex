...
into shapes a bare parser rejects; on the first paper this recovered a dozen
true claims that formatting alone had killed. Such
...
\begin{itemize}[leftmargin=2em]
  \item \textbf{Verification.} Project the operator layer into Lean, allowing
        ...
        the map's 114 nodes carry a machine-checked dimension (the eight left out,
        \texttt{Structure}, \texttt{Potential}, and their fieldless kin, have no
        dimensional content to prove). Tier~2
...
\begin{itemize}[leftmargin=2em, itemsep=0.25em]
  ...
  \item \textbf{Verified layer.} 89 nodes and 12 edge theorems compile against
        ...
        extension lifts dimensional coverage to 106 of 114 nodes (the eight
        remaining are fieldless or opaque, with nothing dimensional to prove),
