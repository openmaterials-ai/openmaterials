...
\begin{itemize}[leftmargin=2em]
  ...
  as an instance (values). The 27 representations on today's map were authored by
...
structured outputs. VALIDATE runs deterministically over the kernel, killing any
