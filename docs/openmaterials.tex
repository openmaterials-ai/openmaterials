...
102 quantities and 98 operators is content-addressed in the log-first store
(Part~\ref{part:kernel}), grown past its frozen genesis version through the
contribution gates, and the whole is held together by a suite of 1401
passing tests.
...
The map is a curated reference graph. Today it holds 102 nodes (99 observable
and hidden quantities plus 3 promoted parameters) and 251 edges. Nodes are
...
Today's map is one hundred fifteen change records past v1, its frozen genesis version:
...
\texttt{2856922db839bfcf7b775d00f92b14ace6fb0cc8bdaa58bfae552ec2be94b908}
(2026-07-11, 215 records), one hundred fifteen change records past the frozen genesis hash
\texttt{e6e8044e92039696417b53b220b0f3f10559a286b0eaabbe7ea4167ff510f6cd}
(2026-07-07, the untouched 100-record prefix). The live numbers:

\begin{itemize}[leftmargin=2em, itemsep=0.25em]
  \item \textbf{Structure.} 102 nodes (99 observable and hidden quantities plus 3
        promoted parameters), 251 rendered links, 104 deduplicated operators,
  ...
  \item \textbf{Representations.} 28 codes mapped, with per-code variable coverage:
  ...
  \item \textbf{Tests.} The suite is 1401 passing.
\end{itemize}
